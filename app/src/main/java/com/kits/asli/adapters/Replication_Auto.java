...
public class Replication_Auto {
    ...
    public Replication_Auto(Context mContext) {
        ...
        url = "http://" + mContext.getString(R.string.SERVERIP) + "/login/index.php";

    }

    public void replicate_all() {
        Log.e("asli_autoQuery_rep", "start");
                            ...
                            switch (state) {
                                ...
                                default:
                                    for (int i = 0; i < il; i++) {
                                        ...
                                        Log.e("asli_autoQuery", qCol.toString());
                                        xCode = code;
                                        LastRepCode = repcode;
                                    }
